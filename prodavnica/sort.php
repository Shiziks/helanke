...
if($konekcija){
    ...
    if($vrednost==1){
        ...
        $ispis="<div class='row'>";
        $upit=$konekcija->prepare($dohvatanjeProizvoda);
        ...
        $ispis="<div class='row'>";
        $upit=$konekcija->prepare($poImenuRastuce);
        $upit->bindParam(":kreni",$kreni,PDO::PARAM_INT);
        $upit->bindParam(":koliko",$koliko, PDO::PARAM_INT);
        $upit->execute();
        $rezultat=$upit->fetchAll();
        ...
        $ispis="<div class='row'>";
        $upit=$konekcija->prepare($poImenuOpadajuce);
        $upit->bindParam(":kreni",$kreni,PDO::PARAM_INT);
        $upit->bindParam(":koliko",$koliko, PDO::PARAM_INT);
        $upit->execute();
        $rezultat=$upit->fetchAll();
        ...
        $ispis="<div class='row'>";
        $upit=$konekcija->prepare($poCeniNaVise);
        $upit->bindParam(":kreni",$kreni,PDO::PARAM_INT);
        $upit->bindParam(":koliko",$koliko, PDO::PARAM_INT);
        $upit->execute();
        $rezultat=$upit->fetchAll();
        ...
        $ispis="<div class='row'>";
        $upit=$konekcija->prepare($poCeniNaNize);
        $upit->bindParam(":kreni",$kreni,PDO::PARAM_INT);
        $upit->bindParam(":koliko",$koliko, PDO::PARAM_INT);
        $upit->execute();
        $rezultat=$upit->fetchAll();
