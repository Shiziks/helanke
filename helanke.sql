...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 05, 2023 at 07:39 PM
...
--
-- Table structure for table `korpaproizvodi`
--

CREATE TABLE `korpaproizvodi` (
  `idkorpaproizvod` int(200) NOT NULL,
  `idkorpa` int(200) NOT NULL,
  `idkorisnika` int(200) DEFAULT NULL,
  `idproizvod` int(200) NOT NULL,
  `idvelicina` int(200) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
(23, 'O Autoru', 'oautoru.php', 1, 0, 0, 6, 0),
...
INSERT INTO `proizvodivelicine` (`idproizvodvelicina`, `idproizvod`, `idvelicina`, `kolicina`) VALUES
(1, 17, 1, 5),
(2, 17, 3, 3),
(3, 17, 4, 7),
(4, 17, 5, 10),
...
--
-- Indexes for table `korpaproizvodi`
--
ALTER TABLE `korpaproizvodi`
  ADD PRIMARY KEY (`idkorpaproizvod`),
  ADD KEY `korpaproizvodi_ibfk_1` (`idproizvod`),
  ADD KEY `idvelicina` (`idvelicina`),
  ADD KEY `idkorpa` (`idkorpa`),
  ADD KEY `idkorisnik` (`idkorisnika`);
...
--
-- AUTO_INCREMENT for table `korpaproizvodi`
--
ALTER TABLE `korpaproizvodi`
  MODIFY `idkorpaproizvod` int(200) NOT NULL AUTO_INCREMENT;
...
--
-- Constraints for table `korpaproizvodi`
--
ALTER TABLE `korpaproizvodi`
  ADD CONSTRAINT `korpaproizvodi_ibfk_1` FOREIGN KEY (`idproizvod`) REFERENCES `proizvodi` (`idproizvod`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ADD CONSTRAINT `korpaproizvodi_ibfk_2` FOREIGN KEY (`idvelicina`) REFERENCES `velicine` (`idvelicine`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ADD CONSTRAINT `korpaproizvodi_ibfk_3` FOREIGN KEY (`idkorpa`) REFERENCES `korpa` (`idkorpa`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `korpaproizvodi_ibfk_4` FOREIGN KEY (`idkorisnika`) REFERENCES `korisnici` (`idkorisnika`);
